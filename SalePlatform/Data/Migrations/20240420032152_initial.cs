    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandSubscriber", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BrandSubscriber_Brand_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brand",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BrandSubscriber_Subscribers_SubscriberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategorySubscriber", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreSubscriber", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StoreSubscriber_Store_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Store",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StoreSubscriber_Subscribers_SubscriberId",
                        column: x => x.SubscriberId,
                        principalTable: "Subscribers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "290d12d1-6975-43c1-bbd7-366e6ef8a2e1", "cfb35265-4eca-4295-b304-6eafde72a3d2", "SuperAdmin", "SUPERADMIN" },
                    { "e3d46120-cd74-4997-848f-805ebd78ece2", "c0c6e21c-614d-4239-b635-cc64835d06a2", "Member", "MEMBER" },
                    { "ea111dd4-3829-4ca9-8912-deebab62ae55", "5f5658d0-dc11-4843-ae8f-6d574d711998", "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "BrandId", "CategoryId", "Color", "CreatedAt", "DeletedAt", "GenderId", "InStock", "IsDeleted", "Name", "Price", "ProductCount", "StoreId", "UpdatedAt" },
                values: new object[] { 1, 1, 1, "Black", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, true, false, "T-Shirt Catton", 19.989999999999998, 1, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
            ...
            migrationBuilder.InsertData(
                table: "ProductImages",
                columns: new[] { "Id", "CreatedAt", "DeletedAt", "ImgUrl", "IsDeleted", "IsMain", "ProductId", "UpdatedAt" },
                values: new object[] { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "yellow-catton-tshirt.png", false, true, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "ProductSize",
                columns: new[] { "Id", "CreatedAt", "DeletedAt", "IsDeleted", "ProductId", "SizeId", "UpdatedAt" },
                values: new object[] { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, 1, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrandSubscriber_BrandId",
                table: "BrandSubscriber",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_BrandSubscriber_SubscriberId",
                table: "BrandSubscriber",
                column: "SubscriberId");

            migrationBuilder.CreateIndex(
                name: "IX_CategorySubscriber_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreSubscriber_StoreId",
                table: "StoreSubscriber",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_StoreSubscriber_SubscriberId",
                table: "StoreSubscriber",
                column: "SubscriberId");
        }
